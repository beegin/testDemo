...
public class WavefrontObjDemo {
    ...
    void createProgramModel() throws IOException {
        ...
        int vertexShader = creates.createShader("org/lwjgl/demo/opengl/assimp/magnet.vs", GL_VERTEX_SHADER_ARB);
        int fragmentShader = creates.createShader("org/lwjgl/demo/opengl/assimp/magnet.fs", GL_FRAGMENT_SHADER_ARB);
        int program = creates.createProgram(vertexShader, fragmentShader);
    ...
    public void createCubemapProgram() throws IOException {
        int vshader = creates.createShader("org/lwjgl/demo/game/cubemap.vs", GL_VERTEX_SHADER);
        int fshader = creates.createShader("org/lwjgl/demo/game/cubemap.fs", GL_FRAGMENT_SHADER);
        int program = creates.createProgram(vshader, fshader);
